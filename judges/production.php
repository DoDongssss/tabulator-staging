<?php 
    ...
    // Replace 'judges' segment with an empty string
    $modifiedURL = str_replace('/judges', '', $currentURL);
    $modifiedURL = str_replace('/production', '/index', $modifiedURL);
...
<body class="relative h-screen m-h-screen flex flex-col items-center justify-center bg-[url('../images/bg.jpg')] object-cover bg-cover bg-no-repeat">
    <div class="absolute top-3 right-6 flex gap-3">
        <button class="px-4 py-2 bg-[#7286D3] rounded-md text-white hover:bg-[#8EA7E9]">Home</button>
        <button class="px-4 py-2 bg-red-500 rounded-md text-white hover:bg-red-600">Logout</button>
    </div>
    <div>
        <h5 class="font-[900] text-4xl tracking-wider text-[#FFF2F2] border-b-2 border-[#7286D3]"><?php echo $_SESSION['user']['name'] ?></h5>
    </div>
    <div class="flex gap-12 mt-10 w-full">
        ...
        <div class="w-1/2 p-6 flex flex-col gap-3 px-12">
            <h1 class="text-center font-bold text-2xl bg-[#7286D3] py-2 rounded-md w-full text-[#FFF2F2] shadow-sm">PRODUCTION</h1>
           <form action="" class="w-full p-6 border border-[#8EA7E9] rounded-md flex flex-col gap-3 mt-6 shadow-md text-[#FFF2F2] backdrop-blur-xl" id="submitProduction">
                <div class="h-[45px] flex gap-12">
                    ...
                    <input type="number" class="border border-gray-500 rounded-md px-6 w-[100px] font-bold text-2xl text-[#7286D3] text-center" min="0" max="25" id="score1" value="" required>
                </div>
                <div class="h-[45px] flex gap-12">
                    <div class="flex items-center justify-between flex-1 text-md font-semibold text-2xl">
                        <p>Body figure % proportion</p>
                ...
                <div class="h-[45px] flex gap-12">
                    ...
                    <input type="number" class="border border-gray-500 rounded-md px-6 w-[100px] font-bold text-2xl text-[#7286D3] text-center" min="0" max="25" id="score4" value="" required>
                </div>
...
<script src="../js/judges/production.js"></script>
