...
<body class="h-screen m-h-screen flex flex-col items-center justify-center bg-[url('../images/bg.jpg')] object-cover bg-cover bg-no-repeat">
    ...
    <div class="flex gap-12 mt-10 w-full">
        ...
        <div class="w-1/2 p-6 flex flex-col gap-3 px-12">
            <h1 class="text-center font-bold text-2xl bg-[#7286D3] py-2 rounded-md w-full text-[#FFF2F2] shadow-sm">PLAYSUIT</h1>
            <form action="" class="w-full p-6 border border-[#8EA7E9] rounded-md flex flex-col gap-3 mt-6 shadow-md text-[#FFF2F2] backdrop-blur-xl" id="submitPlaysuit">
...
<script src="../js/judges/playsuit.js"></script>
